...
public class RunTokenRing010LockBasedLinkedList extends RunTokenRing {

    static final String name = "LockBasedLinkedListTransporter";
    ...
    List<Transporter> createTransporters(int N, int P) {
        return IntStream.range(0, N)
                ...
                .map(j -> {
                    ...
                    return new LockBasedListTransporter(list);
                })
