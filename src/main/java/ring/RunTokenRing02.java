...
import medium.single.ExchangerSingleTokenMedium;
...
@Deprecated
public class RunTokenRing02 {

    // ExchangerSingleTokenMedium

    public static void main(String[] args) throws InterruptedException {
        int ringSize = 10;
        int normalRuns = 10;
        int warmUpRuns = 10;
        String filename = "RunTokenRing03Results" +
                "-rs-" + ringSize +
                "-nr-" + normalRuns +
                "-wr-" + warmUpRuns + ".csv";
        List<Medium> mediums;
        ...
        for (int i = 0; i < warmUpRuns + normalRuns; i++) {
            ...
            mediums = IntStream.range(0, ringSize)
                    ...
                    .map(j -> {
                        ...
                        return new ExchangerSingleTokenMedium(new Exchanger<>(), token);
                    })
